...
export class MarkdownParser {
  ...
  private postProcess(markdown: string): string {
    ...
    // 1. 规范化列表缩进（统一为 4 的倍数）
    // Turndown 默认使用 4 空格,但某些情况下可能产生 1-3 或 5-7 空格的不规范缩进
