...
AI Copy Enhance does **not collect, store, or transmit any user data**.
...
- **host permissions**: Inject UI on ChatGPT pages only
...
**In short: We collect nothing. Your data stays on your device.**
